      ...
      if (context.mounted) {
        final bool? accept = await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
              "Yapmodoro needs the Alarms & Reminders permission to play completion sounds precisely on time in the background.\n\n"
      ...
      if (context.mounted) {
        final bool? acceptBattery = await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
              "To prevent aggressive background task killers from stopping your timer, please exempt Yapmodoro from battery optimization on the next settings screen."
            ),
            actions: [
              TextButton(
                onPressed: () => Navigator.of(context).pop(false),
